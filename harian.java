    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        jumlah.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (a1.matches("")){
                    Toast.makeText(harian.this,"Isi kolom makanan",Toast.LENGTH_SHORT).show();
                    return;
                }
                else if (b1.matches("")){
                    Toast.makeText(harian.this,"Isi kolom transportasi",Toast.LENGTH_SHORT).show();
                    return;
                }
                else if (c1.matches("")){
                    Toast.makeText(harian.this,"Isi kolom pulsa",Toast.LENGTH_SHORT).show();
                    return;
                }
                else if (d1.matches("")){
                    Toast.makeText(harian.this,"Isi kolom kebutuhan lain",Toast.LENGTH_SHORT).show();
                    return;
                }
                else {
                    ...
                    hasil.setText("Pengeluaran Harian Anda : Rp." + output.hitungharian(jumlah) + ",00-");
